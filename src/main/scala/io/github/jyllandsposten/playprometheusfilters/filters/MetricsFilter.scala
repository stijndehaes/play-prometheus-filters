...
import io.github.jyllandsposten.playprometheusfilters.metrics.RequestMetric
...
/**
  ...
  * }}}
  *
  * Metrics can be created by using a [[io.github.jyllandsposten.playprometheusfilters.metrics.RequestMetricBuilder RequestMetricBuilder]].
  * The builder creates and configures the metrics for the class instance.
  *
  * See [[io.github.jyllandsposten.playprometheusfilters.metrics.CounterRequestMetrics CounterRequestMetrics]] and
  * [[io.github.jyllandsposten.playprometheusfilters.metrics.LatencyRequestMetrics LatencyRequestMetrics]] for some provided
  * builders.
  *
  * @param mat
  * @param ec
